...
- [forking-flagd-evaluator](https://github.com/open-feature-forking/flagd-evaluator) - Standalone WASM-first flagd evaluator (alternative approach, see [comparison](docs/rust-wasm-approaches.md))
